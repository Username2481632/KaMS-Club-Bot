...
"""Unified config/path loading.
We load from a simple shell-style env file ip-updater/constants.env so
both Python and Bash share the same paths.
"""
CONSTANTS_FILE = Path(__file__).parent / 'constants.env'
